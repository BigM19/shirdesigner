...
namespace bakaJzspiG.ShirtDesigner.ShirtDesigner.Controllers
{
    ...
    public class SettingsController : DnnController
    {
        ...
        {
            ModuleContext.Configuration.ModuleSettings["ShirtDesigner_Setting1"] = settings.Setting1.ToString();
            ModuleContext.Configuration.ModuleSettings["ShirtDesigner_Setting2"] = settings.Setting2.ToUniversalTime().ToString("u");
